// src/lib.rs
/*
 * Core library for PandasCookbook
 */
...
#[derive(Debug)]
pub struct PandasCookbookProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PandasCookbookProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PandasCookbook processing");
    
    let mut processor = PandasCookbookProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PandasCookbookProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PandasCookbookProcessor::new(false);
